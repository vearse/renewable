    ...
    <div id="reviews" class="tab-pane reviews" :class="{ active: activeTab === 'reviews' }">
        <div class="row">
            <div class="col-xl-9 col-lg-18">
                <div class="user-review-wrap border px-3" :class="{ loading: fetchingReviews }">
                    ...
                    <div v-else >
                        <div class="row my-3">
                            ...
                            <div class="col-8 pl-4">
                                <div class="_13sFCC miQW6D" style="display: flex;">
                                    <ul class="_2jr1F_">
                                        <li class="_28Xb_u"><div class="omG9iE"><span class="_26f_zl">5</span><span class="_2xBWPJ">★</span></div></li>
                                        <li class="_28Xb_u"><div class="omG9iE"><span class="_26f_zl">4</span><span class="_2xBWPJ">★</span></div></li>
                                        <li class="_28Xb_u"><div class="omG9iE"><span class="_26f_zl">3</span><span class="_2xBWPJ">★</span></div></li>
                                        <li class="_28Xb_u"><div class="omG9iE"><span class="_26f_zl">2</span><span class="_2xBWPJ">★</span></div></li>
                                        <li class="_28Xb_u"><div class="omG9iE"><span class="_26f_zl">1</span><span class="_2xBWPJ">★</span></div></li>
                                    </ul>
                                    <ul class="_2Plkj9">
                                        <li class="_28Xb_u"><div><div class="_3UaKsS"><span class="EkB-Xt _1z2lGe" style="width: 100%;"></span></div></div></li>
                                        <li class="_28Xb_u"><div><div class="_3UaKsS"><span class="EkB-Xt _2fGXyl" style="width: 34.7855%;"></span></div></div></li>
                                        <li class="_28Xb_u"><div><div class="_3UaKsS"><span class="EkB-Xt _1ia31G" style="width: 14.8598%;"></span></div></div></li>
                                        <li class="_28Xb_u"><div><div class="_3UaKsS"><span class="EkB-Xt HnnP7O" style="width: 5.57244%;"></span></div></div></li>
                        ...
                        <div class="user-review my-3" v-for="review in reviews.data">
                        ...
                        <div class="review-form">
                            ...
                            <div class="row">
                                <div class="col-md-18">
                                    ...
                                    <div class="form-group">
                                        <label for="attachment">{{ trans('storefront::product.review_form.attachment') }}</label>
                                        <input type="file" name="reviewer_attachment" v-model="reviewForm.reviewer_attachment" id="attachmentFile" class="form-control">
                                        <span class="error-message" v-if="errors.has('reviewer_attachment')" v-text="errors.get('reviewer_attachment')"></span>
                                    </div>
